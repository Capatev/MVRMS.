const idScanner = {
  ...
  getManualData: () => {
    const license = document.getElementById("manualLicense").value
    const name = document.getElementById("manualName").value
    const expiry = document.getElementById("manualExpiry").value
    const licenseClass = document.getElementById("manualClass").value

    if (!license || !name || !expiry || !licenseClass) {
  ...
  verifyID: function () {
    if (this.currentTab === "manual") {
      this.scannedData = this.getManualData()
